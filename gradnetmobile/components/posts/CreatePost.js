...
//           // Kiểm tra nếu có hình ảnh được chọn và URI không rỗng
...
//       formData.append("content", postContent); // dữ liệu nội dung bài viết được thêm vào với khóa là "content"
//       if (selectedImageURI) {
...
//           // đối tượng chứa thông tin về hình ảnh được  thêm vào với khóa là media
...
//         // nếu thành công thì gọi hàm onPostCreated
